...
test('entry bundles advance cache-bust markers without changing the formal release badge', () => {
  assert.equal(index.includes('/static/app.js?v=42.25.173'), true);
  assert.equal(index.includes('/static/main.mjs?v=42.25.174'), true);
  ...
  assert.equal(index.includes('/static/modules/training-task-visibility-runtime.js?v=422543'), true);
  assert.equal(main.includes("./modules/material-pagination-runtime.js?v=422211"), true);
