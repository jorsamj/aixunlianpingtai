...
test('backend processing percent is displayed unchanged',()=>{assert.equal(backendZipProgress(running),31.4);assert.equal(zipView(running,[running]).progress,31.4)});
