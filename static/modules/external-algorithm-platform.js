...
export function installExternalAlgorithmPlatformRuntime({
  ...
  function readinessHtml() {
    ...
    return `<section class="panel" data-changlian-readiness="${readiness.ready ? 'ready' : 'blocked'}">
      <div class="panel-head"><div><div class="panel-title">联调准备状态 · 主数据 / 训练</div><div class="subline">这里只检查应用鉴权、主数据同步和当前项目畅联云算法是否可进入训练；转换与版本/权重发布由版本页同步前的发布预检单独判断。</div></div></div>
      <div class="panel-body">
