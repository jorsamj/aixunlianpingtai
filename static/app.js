...
window.installUsability417=function(){
  ...
  render=function(){const result=baseRender417?.(),badge=document.getElementById('versionBadge'),footer=document.querySelector('.nav-footer b');if(badge)badge.textContent='v42.22.4';if(footer)footer.textContent='v42.22.4';return result};
  [120,600,1600].forEach(delay=>setTimeout(()=>{const badge=document.getElementById('versionBadge'),footer=document.querySelector('.nav-footer b');if(badge)badge.textContent='v42.22.4';if(footer)footer.textContent='v42.22.4'},delay));
