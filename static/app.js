...
(()=>{
  ...
  window.openVersionEvaluation429=function(aid,vid){
    ...
    const comparisonReason={benchmark_scope_missing:'历史版本缺少固定评测基准',benchmark_scope_mismatch:'前后版本 Test Scope 不同',evaluation_protocol_missing:'历史版本缺少评测协议身份',evaluation_protocol_mismatch:'前后版本评测协议不同'};
