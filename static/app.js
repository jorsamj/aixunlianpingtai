...
(()=>{
  ...
  window.doUploadZip426=async function(inp){if(!inp?.files?.length)return;if(!window.ZipImportRuntime?.upload)return toast('ZIP 导入模块正在加载，请稍后重试');return window.ZipImportRuntime.upload(inp).catch(()=>null)};
