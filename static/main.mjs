...
import {installTrainingLabelRuntime} from './modules/training-labels.js?v=422510';
...
import {installTrainingDraftRuntime} from './modules/training-draft-runtime.js?v=422513';
