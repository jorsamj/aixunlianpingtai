...
import {installTrainingLabelRuntime} from './modules/training-labels.js?v=422506';
...
import {createTrainingDraft, trainingDraftFromLegacyState, trainingDraftToRequest, trainingInheritanceFromAlgorithm} from './modules/training-draft.js?v=422504';
import {installTrainingDraftRuntime} from './modules/training-draft-runtime.js?v=422506';
