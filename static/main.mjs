...
import {installTrainingDraftControls} from './modules/training-draft-controls.js?v=422500';
...
import {FULL_MATERIAL_PAGES, buildMaterialQuery, installMaterialPaginationRuntime, requiresFullMaterialPool} from './modules/material-pagination-runtime.js?v=422204';
